...
const About = () => {
  return (
    <div className="flex flex-col items-start justify-start divide-y divide-gray-200 md:justify-center md:items-center md:divide-y-0 md:flex-row md:space-x-6 md:mt-12">

...
const BigTag = ({ text, count }: Props) => {
  return (
    ...
    >
      <span className="hover:bg-primary-50 relative z-10 inline-flex items-center overflow-hidden rounded-l-full border border-primary-200 px-4 py-1.5 text-sm font-medium uppercase tracking-wide text-primary-600 transition-all duration-300 hover:border-primary-300 hover:text-primary-700 dark:border-teal-800 dark:text-teal-300 dark:hover:border-teal-700 dark:hover:bg-teal-900/20 dark:hover:text-teal-200">

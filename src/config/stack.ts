...
export const StackInfo: Partial<Record<Stack, StackInfoMap>> = {
  ...
  [Stack.spring_boot]: { value: "Spring Boot", color: Colors.spring },
  [Stack.spring_cloud]: { value: "Spring Cloud", color: Colors.spring },
  ...
  [Stack.gitlabci]: { value: "GitLab CI", color: Colors.gitlabci },
  [Stack.argocd]: { value: "ArgoCD", color: Colors.argocd },
  [Stack.kubernetes]: { value: "Kubernetes", color: Colors.kubernetes },
  [Stack.helm]: { value: "Helm", color: Colors.helm },
  [Stack.rancher]: { value: "Rancher", color: Colors.rancher },
};
